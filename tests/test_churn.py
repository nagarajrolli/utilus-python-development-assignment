...
class TestMonthlyChurn:
    ...
    def test_ended_subscription_with_no_resubscription_is_churn(
        self, metric, no_customers
    ):
        subs = make_subscriptions([("C001", "2024-01-01", "2024-03-15", 30)])
        months = {
            r["month"]: r["churned_customers"]
            for r in metric.compute(no_customers, subs)
        }
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                "2024-03",
                0,
            ),  # exactly 30 days — inclusive boundary
